...
var ScrollPicker = {
  ...
  methods: {
    ...
    onScroll(e) {
      ...
      const deltaMax = e.deltaY > 0 ? this.findScrollByIndex(nextDirInnerIndex - 1) - this.findScrollByIndex(nextDirInnerIndex) : this.findScrollByIndex(nextDirInnerIndex) - this.findScrollByIndex(nextDirInnerIndex + 1);
...
var entry_esm = /*#__PURE__*/(() => {
  ...
  const installable = ScrollPicker; // Attach install function executed by Vue.use()
...
export { ScrollPicker, ScrollPickerGroup, entry_esm as default };
